...
const InternshipCard = ({ intern, index }) => (
  ...
  >
    <div>
      ...
      <p className="text-blue-200 text-sm font-black tracking-wide mb-6 uppercase">
        {intern.organization}
      </p>
      ...
      <div className="mb-6">
        ...
        <ul className="text-white/90 text-sm font-medium space-y-2 pl-4 list-disc">
...
const Internships = () => {
  return (
    <section className="bg-[#2563eb] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-blue-100 text-base md:text-lg font-semibold max-w-lg mx-auto">
